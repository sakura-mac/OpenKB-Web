...
func main() {
	...
	api := r.Group("/api")
	{
		...
		api.POST("/code/stream", handler.CodeStream)
		api.POST("/code/sync", handler.SyncCodeSpace)
		api.GET("/code/sessions/:space", handler.ListCodeSessions)
		api.GET("/code/session/:space/:sid", handler.LoadCodeSession)
		api.DELETE("/code/session/:space/:sid", handler.DeleteCodeSession)
		api.GET("/code/suggestions/:space", handler.CodeSuggestions)
		api.GET("/code/graph/:space", handler.CodeGraphNeighbors)
		api.GET("/code/symbol/:space", handler.CodeSymbolSource)
