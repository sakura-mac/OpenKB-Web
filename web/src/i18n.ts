...
const messages = {
  'zh-CN': {
    ...
    settings: {
      ...
      language: '回答语言',
      auxModel: '辅助模型（可选）',
      auxModelPlaceholder: '如 deepseek-v4-flash、gemini-2.0-flash 等',
      auxModelHelp: 'fact-check / 追问卡片 / 推荐等轻量任务使用。为空则回退到主模型，可省额度/提速。',
      checkBtn: '测试连接',
      checkingBtn: '测试中…',
    ...
    code: {
      ...
      factCheckRunning: '事实校验中 · 比对 codegraph 索引…',
      factCheckPassed: '事实校验通过 ✓',
      factCheckRetry: '事实校验未通过 · 重新核实修订中…',
      factCheckSource: '源码精校中 · 验证文件/行号细节…',
      contextCompressing: '上下文超限 · 总结历史压缩中…',
      contextCompressed: '上下文已压缩 · 继续推理…',
      bestOfNRunning: '并行 3 条探索中 · 取最优…',
      agentTrace: '探索过程',
      catSymbol: '符号',
      catFile: '文件',
      catSearch: '搜索',
  ...
  en: {
    ...
    settings: {
      ...
      auxModel: 'Auxiliary model (optional)',
      auxModelPlaceholder: 'e.g. deepseek-v4-flash, gemini-2.0-flash',
      auxModelHelp: 'Used for fact-check / follow-ups / suggestions. Falls back to main model if empty.',
    ...
    code: {
      ...
      factCheckRunning: 'Fact-checking · cross-referencing codegraph index…',
      factCheckPassed: 'Fact-check passed ✓',
      factCheckRetry: 'Fact-check failed · re-verifying & revising…',
      factCheckSource: 'Source-level verification · checking file/line details…',
      contextCompressing: 'Context limit · summarizing history…',
      contextCompressed: 'Context compressed · resuming…',
      bestOfNRunning: '3× parallel exploration · picking best…',
