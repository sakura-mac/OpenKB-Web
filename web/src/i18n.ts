...
const messages = {
  'zh-CN': {
    ...
    bootstrap: {
      ...
      slowHint: '首次安装通常 30~90 秒，期间会下载 Python 与 OpenKB 依赖（~200MB）。请保持网络通畅。',
      phase: {
        pending: '准备启动...',
        checking: '检查引擎状态...',
        downloadUv: '下载 uv 工具链...',
        installing: '安装 OpenKB（需联网）...',
        releasing: '释放运行时资源...',
        ready: '就绪',
        failed: '初始化失败',
      },
  ...
  en: {
    ...
    bootstrap: {
      ...
      slowHint: 'First-time setup usually takes 30~90s and downloads Python + OpenKB deps (~200MB). Keep your connection stable.',
      phase: {
        pending: 'Standing by...',
        checking: 'Checking engine status...',
        downloadUv: 'Downloading uv toolchain...',
        installing: 'Installing OpenKB (requires network)...',
        releasing: 'Releasing runtime resources...',
        ready: 'Ready',
